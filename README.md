...
21 - перефразирован нейронкой в конце

22 - перефразирован нейронкой в конце

23 - инфа лекция + методичка немного

24 - инфа лекция + методичка немного

*Вопрос* - информация из методичек (надо смотреть)
...
**12. Распараллеливание циклических фрагментов программ (синтетический алгоритм, объединяющий метод параллелепипедов и пирамид).** - нет нигде
